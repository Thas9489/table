  ...
  return (
    <>
      <div className="flex items-center gap-4 px-5 py-4 hover:bg-slate-50 transition-colors group">
        ...
        >
          {isIncome
            ? <TrendingUp  size={16} style={{ color: cat?.color ?? '#059669' }} />
        ...
        {isImageAttachment && transaction.attachment_url && (
          ...
          >
            ...
            <img
              ...
              className="w-8 h-8 rounded-lg object-cover border border-slate-200 hover:border-indigo-400 transition-all"
            />
          </a>
        )}
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 py-2 rounded-lg border border-slate-200 text-sm font-medium text-slate-600 hover:bg-slate-50 transition-all"
            >
              Cancel
            </button>
            <button
              ...
              disabled={deleting}
              className="flex-1 py-2 rounded-lg bg-red-50 border border-red-200 text-sm font-medium text-red-600 hover:bg-red-100 transition-all disabled:opacity-50"
            >
